...
var redirectToService = function(callbackUrl, cb) {
  ...
  cb(null, globalConn.oauth2.getAuthorizationUrl({ scope : 'api id refresh_token', prompt: 'consent' }), {});
};
...
var additionQueueWorker = function(job, cb) {
  ...
  upload(job.serviceDara.instanceUrl, job.task, job.anyfetchClient, cb);
};
